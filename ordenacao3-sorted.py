...
# Ordenar estudantes pela variável nota_media de forma decrescente
estudantes_ordenados_nota = sorted(estudantes, key=lambda x: x['nota_media'], reverse=True)
# Mostra lista ordenada de nome por nota média decrescente
...
# Ordenar estudantes pela variável nome em ordem alfabética
